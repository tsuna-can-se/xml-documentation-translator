...
var outputDirectoryPath = builder.Configuration.GetValue<string>("OutputDirectoryPath");
ParameterNotSetException.ThrowIfNotSet(outputDirectoryPath, "OutputDirectoryPath");
